...
})({"gMSD4":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "64977b5614d5b876";
"use strict";
...
},{}],"4CQXS":[function(require,module,exports) {
...
const basic = "!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ ";
const latinExtendedA = "ĀāĂăĄąĆćĈĉĊċČčĎďĐđĒēĖėĘęĚěĜĝĞğĠġĢģĤĥĦħĨĩĪīĮįİıĲĳĴĵĶķĹĺĻļĽľŁłŃńŅņŇňŊŋŌōŐőŒœŔŕŖŗŘřŚśŜŝŞşŠšŢţŤťŦŧŨũŪūŬŭŮůŰűŲųŴŵŶŷŸŹźŻżŽž";
const latinExtendedB = "ȘșȚțȷ";
const spacingModifiers = "ˆˇ˘˙˚˛˜˝";
const latinExtendedAdditional = "ḠḡẀẁẂẃẄẅẞẼẽỲỳỸỹ";
const generalPunctuation = "​–—‘’‚“”„†‡•… ‰″‹›⁄";
const superscriptsSubscripts = "⁰\xb9\xb2\xb3⁴⁵⁶⁷⁸⁹₀₁₂₃₄₅₆₇₈₉";
const symbols = "€™⅛⅜⅝⅞←↑→↓↔↕↖↗↘↙⇧∂∅∏∑−√∞∫≈≠≤≥⌗⌘⌥";
const shapes = "■□▲△▶▷▼▽◀◁◆◇◊○●";
...
function createGlyphCells(charSet) {
    const cells = [];
    for(let i = 0, n = Math.ceil(charSet.length / 10); i < n; i++)for(let j = 0; j < 10; j++){
        const cell = document.createElement("div");
        const char = charSet[i * 10 + j];
        cell.textContent = char;
        if (char) cell.classList.add("glyph");
        cells.push(cell);
    }
    return cells;
}
...
document.querySelectorAll(".grid").forEach((grid)=>{
    ...
    grid.addEventListener("focusin", (e)=>{
        const { target } = e;
        if (target.classList.contains("glyph")) displayGlyph.textContent = target.textContent;
    });
});
...
},{"roving-grid-ux":"faleX"}]},["gMSD4","4CQXS"], "4CQXS", "parcelRequiree3ac")

//# sourceMappingURL=glyph-browser.14d5b876.js.map
